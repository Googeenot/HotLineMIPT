...
class Game():
    ...
    def create_enemies(self):
        ...
        for i in range(Enemies.k_en):
            ...
            r_en.append(poligon.Enemies(Enemies.b[i][0], Enemies.b[i][1], 10, 10, (100, 100, 100), 5, i,

                                        self.shina[poligon][0].bounds))
    ...
    def create_pen(self):
        ...
        pen = weapon.Pen(510, 250, 10, 10, self.shina[poligon][0].bounds)
